...
Record({
    $id: Now.ID['2dd1d5eeeb693e904870fc4dbad0cd78'],
    table: 'sys_data_source',
    data: {
        batch_size: '1000',
        connection_timeout: '0',
        connection_url:
            'attachment://sys_data_source:2dd1d5eeeb693e904870fc4dbad0cd78/insurance_realistic_data 1 (1).xlsx',
 ...
 // Add your code here to insert data to import_set_table 
        ...
        file_path: 'insurance_realistic_data 1 (1).xlsx',
        ...
        maximum_rows: '10000',
        name: 'insurance_realistic_data 1 (1).xlsx (Upl',
        offset: '0',
        oracle_port: '1521',
        oracle_sid: 'orcl',
