...
Record({
    $id: Now.ID['49d21da2eba93e904870fc4dbad0cd5e'],
    table: 'sys_data_source',
    data: {
        batch_size: '1000',
        connection_timeout: '0',
        connection_url:
            'attachment://sys_data_source:49d21da2eba93e904870fc4dbad0cd5e/insurance_realistic_data 1 (2).xlsx',
 ...
 // Add your code here to insert data to import_set_table 
        ...
        file_path: 'insurance_realistic_data 1 (2).xlsx',
        ...
        maximum_rows: '10000',
        name: 'insurance_realistic_data 1 (2).xlsx (Upl',
        offset: '0',
        oracle_port: '1521',
        oracle_sid: 'orcl',
