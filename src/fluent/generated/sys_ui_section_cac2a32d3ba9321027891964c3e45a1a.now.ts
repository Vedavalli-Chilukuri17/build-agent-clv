...
Record({
    $id: Now.ID['06c2a32d3ba9321027891964c3e45a20'],
    table: 'sys_ui_element',
    data: {
        element: 'tier',
        position: 1,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af1'],
    table: 'sys_ui_element',
    data: {
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af2'],
    table: 'sys_ui_element',
    data: {
        element: 'churn_risk',
        position: 5,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af3'],
    table: 'sys_ui_element',
    data: {
        element: 'quote_views',
        position: 7,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af4'],
    table: 'sys_ui_element',
    data: {
        element: '.split',
        position: 9,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af5'],
    table: 'sys_ui_element',
    data: {
        element: 'last_name',
        position: 11,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af6'],
    table: 'sys_ui_element',
    data: {
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45af7'],
    table: 'sys_ui_element',
    data: {
        element: 'preferred_channel',
        position: 15,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45af8'],
    table: 'sys_ui_element',
    data: {
        element: '.end_split',
        position: 18,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45af9'],
    table: 'sys_ui_element',
    data: {
        element: '.begin_split',
        position: 20,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45afa'],
    table: 'sys_ui_element',
    data: {
        element: 'phone',
        position: 22,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45afb'],
    table: 'sys_ui_element',
    data: {
        element: '.split',
        position: 24,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45afc'],
    table: 'sys_ui_element',
    data: {
        element: 'clv_score',
        position: 25,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45afc'],
    table: 'sys_ui_element',
    data: {
        element: 'email',
        position: 26,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45afd'],
    table: 'sys_ui_element',
    data: {
        element: 'number_of_closed_accounts',
        position: 27,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45afd'],
    table: 'sys_ui_element',
    data: {
        element: '.end_split',
        position: 28,
...
Record({
    $id: Now.ID['c2c2afe13be9321027891964c3e45afe'],
    table: 'sys_ui_element',
    data: {
        element: 'risk_flags',
        position: 29,
...
Record({
    $id: Now.ID['cac2afe13be9321027891964c3e45afe'],
    table: 'sys_ui_element',
    data: {
        element: 'bankruptcies_flag',
        position: 30,
...
Record({
    $id: Now.ID['eaa32fa53be9321027891964c3e45acb'],
    table: 'sys_ui_element',
    data: {
        element: 'name',
        position: 31,
...
Record({
    $id: Now.ID['64f3afe53be9321027891964c3e45a42'],
    table: 'sys_ui_element',
    data: {
        element: 'customer_id',
        position: 32,
...
Record({
    $id: Now.ID['cac2a32d3ba9321027891964c3e45a1a'],
